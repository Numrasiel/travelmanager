...
import com.travelmanager.domain.RouteDataOnDemand;
...
privileged aspect RouteDataOnDemand_Roo_DataOnDemand {
    ...
    public Route RouteDataOnDemand.getNewTransientRoute(int index) {
        Route obj = new Route();
        setEndPoint(obj, index);
        setStartPoint(obj, index);
        return obj;
    }
    
    public void RouteDataOnDemand.setEndPoint(Route obj, int index) {
        EndPoint endPoint = null;
        obj.setEndPoint(endPoint);
    }
    
    public void RouteDataOnDemand.setStartPoint(Route obj, int index) {
        StartPoint startPoint = null;
        obj.setStartPoint(startPoint);
    }
